...
/// Generic Raft RPC message
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RaftMessage {
    #[prost(string, tag = "1")]
    pub rpc_type: ::prost::alloc::string::String,
    #[prost(bytes = "vec", tag = "2")]
    pub data: ::prost::alloc::vec::Vec<u8>,
}
/// Generic Raft RPC reply
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod raft_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send_raft(
            ...
            let path = http::uri::PathAndQuery::from_static("/raft.Raft/SendRaft");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("raft.Raft", "SendRaft"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/raft.Raft/SendRaft" => {
                    ...
                    struct SendRaftSvc<T: Raft>(pub Arc<T>);
                    ...
                    for SendRaftSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Raft>::send_raft(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
